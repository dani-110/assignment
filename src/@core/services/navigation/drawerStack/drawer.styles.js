...
export const styles = StyleSheet.create({
    ...
    headerMain: { flexDirection: 'row', justifyContent: 'space-between', padding: hp('1%') },
    activeStatus: { height: hp('2%'), width: hp('2%'), borderRadius: hp('100%'), marginHorizontal: wp('1.5%'), marginTop: hp('0.5%') },
