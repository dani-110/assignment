...
typedef NS_ERROR_ENUM(kTVOErrorDomain, TVOError) {
    ...
    TVOErrorConflictError                                 = 31409,    ///< The request could not be processd because of a conflict in the current state of the resource. Another request may be in progress
    ...
    TVOErrorDNSResolutionError                            = 31530,    ///< Could not connect to the serever due to DNS resolution failure
