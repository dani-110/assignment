...
typedef NS_ERROR_ENUM(kTVOErrorDomain, TVOError) {
    ...
    TVOErrorRateExceededError                             = 31206,    ///< Rate exceeded authorized limit.
    TVOErrorCallMessageEventPayloadSizeExceededError      = 31209,    ///< Call message event payload size exceeded authorized limit.
